...
const getAll =  async (req,res) => {
    try{
        ...
        var select = " SELECT o.* , os.name as order_status_name , pm.name as payment_methode_name ";
        ...
        if (!isEmptyOrNull(txtSearch)){
            where += " AND o.telephone = ? OR o.invoice_no LIKE ? OR o.firstname LIKE ? OR o.lastname LIKE ? "; // Use parentheses to group conditions
        ...
        var order = " ORDER BY o.order_status_id DESC "
